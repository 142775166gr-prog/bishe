...
INSERT INTO `admin` VALUES (7, 'admin', 'admin1', '123456', '111', '111', '111', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '在线咨询表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of consultation
-- ----------------------------
INSERT INTO `consultation` VALUES (1, 1, '张三', 1, '张三', 1, 'Java基础入门', 'Java中的多态如何理解？', '老师您好，我在学习Java面向对象编程时，对多态的概念不太理解，能否举例说明一下？', NULL, '多态是指同一个方法调用，由于对象不同可能会有不同的行为。例如：父类引用指向子类对象时，调用重写的方法会执行子类的实现。这是运行时多态的体现。', '2026-01-12 10:30:00', 1, 0, 1, '2026-01-12 09:00:00', '2026-03-19 14:32:43', 1);
...
INSERT INTO `consultation` VALUES (3, 1, '张三', 1, '何老师', 100, '高等数学（上册）', '关于等价无穷小替换的使用疑问', '老师您好，我在计算极限 lim(x→0) (tanx - sinx)/x³ 时，直接用 tanx ~ x 和 sinx ~ x 替换后得到结果为 0，但和正确答案 -1/6 不符，想请教等价无穷小替换在加减运算中的适用条件。', NULL, NULL, NULL, 0, 0, 0, '2026-03-19 14:35:03', '2026-03-19 14:40:16', 1);
INSERT INTO `consultation` VALUES (4, 1, '张三', 1, '何老师', 100, '高等数学（上册）', '求极限问题', 'x 趋近于 0 时，sinx 除以 x 的极限是多少？', NULL, '当 x 趋近于 0 时，sinx 与 x 是等价无穷小，所以极限等于 1。', '2026-03-19 14:42:33', 1, 0, 1, '2026-03-19 14:41:37', '2026-03-19 14:41:36', 0);
...
-- ----------------------------
INSERT INTO `education_suggestion` VALUES (1, 9, '王老师', 1, '张三', 1, 'Java基础入门', 1, '关于Java学习的建议', '根据你最近的学习情况，建议你多做一些编程练习，加强对面向对象概念的理解。可以尝试自己设计一些小项目来巩固知识。', 1, 0, '2026-01-12 09:00:00', '2026-01-12 09:30:00', 0);
INSERT INTO `education_suggestion` VALUES (2, 1, '何老师', 1, '张三', 100, '高等数学（上册）', 2, '推荐学习资源', '建议你学习完Java基础后，可以继续学习数据结构与算法，这对编程能力的提升很有帮助。', 1, 0, '2026-01-12 10:00:00', '2026-01-25 17:22:58', 0);
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (1, '张三', '13579', '24680', '1213', '761542@qq.com', 'XX大学', '/uploads/images/3768c345-ef63-45fa-a9f0-3fb62e7cd377.jpeg', 0);
...
INSERT INTO `student` VALUES (21, '测试学生', 'student1', '123456', '111', '222', '333', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生考试记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student_exam_record
-- ----------------------------
INSERT INTO `student_exam_record` VALUES (1, 1, 201, '2026-03-19 14:21:26', NULL, 120, NULL, NULL, 0, 1, NULL, '2026-03-19 14:21:26');
...
INSERT INTO `teacher` VALUES (14, '测试教师', 'teacher1', '123456', '111', '222', '333', '444', '', 0);
